...
<head>
    ...
    <link href="{{asset('aee/')}}/layouts/vertical-dark-menu/css/light/loader.css" rel="stylesheet" type="text/css" />
    <link href="{{asset('aee/')}}/layouts/vertical-dark-menu/css/dark/loader.css" rel="stylesheet" type="text/css" />
    <script src="{{asset('aee/')}}/layouts/vertical-dark-menu/loader.js"></script>

    <!-- BEGIN GLOBAL MANDATORY STYLES -->
    <link href="https://fonts.googleapis.com/css?family=Nunito:400,600,700" rel="stylesheet">
    <link href="{{asset('aee/')}}/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <link href="{{asset('aee/')}}/layouts/vertical-dark-menu/css/light/plugins.css" rel="stylesheet" type="text/css" />
    <link href="{{asset('aee/')}}/layouts/vertical-dark-menu/css/dark/plugins.css" rel="stylesheet" type="text/css" />
    <!-- END GLOBAL MANDATORY STYLES -->

    <!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM STYLES -->
    <link href="{{asset('aee/')}}/plugins/src/apex/apexcharts.css" rel="stylesheet" type="text/css">
    <link href="{{asset('aee/')}}/assets/css/light/dashboard/dash_1.css" rel="stylesheet" type="text/css" />
    <link href="{{asset('aee/')}}/assets/css/light/widgets/modules-widgets-vlm.css" rel="stylesheet" type="text/css" />
