...
(function($) {
  ...
  $('input[required].form-control').each(function () {
      // Get the 'for' attribute of the label associated with this input
      var labelFor = $(this).attr('id');

      // Find the label element by its 'for' attribute
      var label = $('label[for="' + labelFor + '"]');

      label.append("<span class='text-danger mx-1'>*</span>")
  });
